            ...
            <div className="shadow-lg w-9/12 h-full bg-white flex">
                <div className="w-4/12 border-r-2 h-full border-gray-200">
                    ...
                    {/* <div className="text-sm p-7 pt-4 text-center text-gray-500">
                        ...
                        adipisicing elit. Nobis dolorem ullam et aut? Qui, odio!
                        Itaque atque, ab ex accusantium accusamus eius
                    </div> */}
                    {/* <div className="w-full flex justify-center">
                        <button className="w-fit bg-[#00ADB5] text-white py-2 px-8 rounded-[3px] text-sm">
                            Send Email
                        </button>
                    </div> */}
                </div>
                <div className="w-8/12 grid grid-rows-2">
                    <div className="border-b-2 border-gray-200 px-36 pt-9">
                        <h1 className="opacity-60 font-semibold text-center">
                            Thay đổi thông tin
                        </h1>
                        <div className="mt-5 flex flex-col gap-2">
                            ...
                            <input
                                ...
                                className=" py-1 border-b focus:outline-none"
                            />
                            <input
                                value="Input component"
                                className=" py-1 border-b focus:outline-none"
                            ...
                            <input
                                ...
                                className="py-1 border-b focus:outline-none"
                            />
                            <button className="w-fit mt-2 bg-[#00ADB5] text-white py-2 px-8 rounded-full text-sm m-auto">
                                Lưu
                            </button>
                        </div>
                    </div>
                    {/* <div className="border-b-2 border-gray-200 p-10 pt-6">
